...
//PRELOADER
    ...
    $(function() {
        function loadbar() {
            ...
            //img = document.images,
            img = document.querySelectorAll("img.work-image"),
                c = 0,
                tot = img.length;
            console.log("images to load: ", img.length);

            totalImgs = document.images, c = 0, total = totalImgs.length;
...
// PROJECT LOADING LOGIC
    ...
    var onClick = function() {
        ...
        main_img.on('load', function() {
          	$(".project-main-bg").animate({backgroundColor: "rgba(0, 0, 0, 0)"}, 500 );
		...
		$(".project-img").on('load', function() {$(".project-img").fadeTo(500, 1); });     
